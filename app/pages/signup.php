<?php 
  ...
  if(!empty($_POST))
  {
    ...
    {
      $errors['username'] = "Can only have letters and no spaces";
    }
...
<main class="form-signin w-100 m-auto">
  <form method="post">
    ...
    <div class="my-2">Already have account  <a href="<?=ROOT?>/login">Login</a></div>
    ...
    <p class="mt-5 mb-3 text-muted">&copy; <?= date("2020 - Y")?></p>
  </form>
</main>
