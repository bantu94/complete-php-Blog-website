...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Gwanga Mujje</a>
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link" href="<?=ROOT?>">
                  <i class="bi bi-house-up" class="align-text-bottom"></i>
                  Frontend
                </a>
              </li>
            </ul>
